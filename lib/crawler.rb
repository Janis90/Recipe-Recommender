...
class Sanitizer
  ...
  def sanitize_ingredients(array_of_ingredient_descriptions)
    ignore_words = %w(Abrieb Amarenakirschen American Anbraten Auflaufform Ausbacken Ausrollen Ausstreichen B Backen Becher Bedarf
                      ...
                      Zartbitter Zweig Zweige ¼ ½ -2 "edelsüß" übrigens)
